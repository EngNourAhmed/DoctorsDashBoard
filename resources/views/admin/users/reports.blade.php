    ...
    <div class="space-y-6">
        ...
        <div class="bh-table-transparent rounded-xl border border-white/10 bg-[#0c0c0c]">
            <div class="overflow-x-auto overflow-y-visible pb-4">
                <table class="w-full text-left text-gray-300 whitespace-nowrap relative">
                    <thead>
                        <tr>
                        ...
                        @foreach ($reports as $report)
                            <tr class="transition-colors group hover:bg-white/[0.03]">
                                <td class="px-5 py-3">
                                    <div class="text-white font-bold text-xs">
                                        ...
                                        @if ($report->files_count > 1)
                                            <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-[8px] font-bold bg-amber-400/10 text-amber-400 border border-amber-400/20">
                                ...
                                <td class="px-5 py-3 border-b border-white/10">
                                    @if ($report->files_count > 1)
                                        <div class="flex flex-col gap-0.5">
                                            ...
                                            <a href="{{ route('admin.cases.batch', $report->batch_id) }}" class="text-[#FACC15] hover:underline text-[10px] font-black ml-5">
                                    ...
                                    @else
                                        <div class="flex flex-col gap-0.5">
                                            ...
                                            <button type="button" 
                                                ...
                                                class="text-[#FACC15] hover:underline text-[10px] font-black ml-5 text-left">
                                                View File
                                            </button>
                                        </div>
                                    @endif
                                ...
                                <td class="px-5 py-3 text-right border-b border-white/10">
                                    <div class="relative inline-block w-[140px] scale-90 text-left dropdown-container">
